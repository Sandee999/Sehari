...
export default function SignUP() {
  ...
  const message = (userData?.username) ? 'Complete your Profile' : 'Let’s set up your profile!';
  const [chatData, setChatData] = useState([
    { text: message, user: false, error: false },
  ]);
  ...
  return (
    <>
      ...
      <StatusBar animated style='light' backgroundColor='black' hidden />
    </>
  );
}