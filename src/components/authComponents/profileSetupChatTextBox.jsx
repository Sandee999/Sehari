...
export default function ProfileSetupChatTextBox({user, setUser, setChatData}) {
  ...
  return (
    <>
      <View className={`w-[100vw] min-h-[10vh] z-30 flex-row items-center justify-evenly`}>
        {currentInput!=='DOB' ?
          <TextInput 
            className={`w-[70vw] min-h-12 h-auto py-4 px-5 text-xl font-semibold bg-[#FFFFFFEE] rounded-3xl`}
